...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'frontend_fileinput', (
            (u'input_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['frontend.Input'], unique=True, primary_key=True)),
    ...
    models = {
        ...
        u'frontend.fileinput': {
            'Meta': {'ordering': "('order',)", 'object_name': 'FileInput', '_ormbases': [u'frontend.Input']},
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            u'input_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['frontend.Input']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'frontend.input': {
